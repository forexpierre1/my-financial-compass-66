  ...
  return (
    <div className="min-h-screen bg-background flex relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-0 left-1/4 w-[800px] h-[800px] rounded-full bg-primary/5 blur-[150px]" />
        <div className="absolute bottom-0 right-1/4 w-[600px] h-[600px] rounded-full bg-purple-500/5 blur-[120px]" />
      </div>
      ...
      <div className="hidden lg:flex lg:w-[55%] relative overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden">
          <div className="absolute top-20 left-20 w-[400px] h-[400px] rounded-full bg-primary/15 blur-[100px] animate-pulse-slow" />
          <div className="absolute bottom-40 right-10 w-[350px] h-[350px] rounded-full bg-purple-500/15 blur-[80px] animate-pulse-slow" style={{ animationDelay: '1.5s' }} />
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] rounded-full bg-primary/5 blur-[120px] animate-pulse-slow" style={{ animationDelay: '3s' }} />
        </div>
        ...
        <div className="absolute top-0 right-1/4 w-px h-full bg-gradient-to-b from-transparent via-purple-500/15 to-transparent" />
        ...
        <div className="relative z-10 flex flex-col justify-between w-full px-12 py-10">
          ...
          <div className="flex-1 flex flex-col justify-center max-w-xl">
            ...
            <div className="relative inline-flex w-fit mb-8">
              ...
              <div className="relative inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 border border-primary/30 backdrop-blur-sm">
                <Sparkles className="h-4 w-4 text-primary animate-pulse" />
                <span className="text-sm font-semibold text-primary tracking-wide">IA-POWERED FINANCIAL ENGINE</span>
              </div>
            </div>
            ...
            <h1 className="font-display text-5xl xl:text-6xl font-bold leading-[1.1] mb-6">
              ...
              <span className="block mt-2 bg-gradient-to-r from-primary via-purple-400 to-primary bg-clip-text text-transparent bg-[length:200%_auto] animate-[gradient_3s_linear_infinite]">
                Financière
              </span>
            ...
            <div className="grid grid-cols-3 gap-4">
              {features.map((feature, index) => (
                <div 
                  key={index}
                  className="group relative p-4 rounded-xl bg-card/30 backdrop-blur-md border border-white/5 hover:border-primary/30 transition-all duration-300 hover:bg-card/50 overflow-hidden"
                >
                  {/* Card Glow */}
                  <div className="absolute inset-0 bg-gradient-to-br from-primary/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity" />
                  
                  <div className="relative">
                    <div className="h-10 w-10 rounded-lg bg-gradient-to-br from-primary/20 to-purple-500/20 flex items-center justify-center mb-3 group-hover:shadow-[0_0_20px_rgba(14,165,233,0.3)] transition-shadow">
      ...
      <div className="w-full lg:w-[45%] flex items-center justify-center p-6 lg:p-12 relative">
        ...
        <div className="absolute top-1/4 right-1/4 w-[300px] h-[300px] rounded-full bg-primary/10 blur-[100px]" />
        <div className="absolute bottom-1/4 left-1/4 w-[250px] h-[250px] rounded-full bg-purple-500/10 blur-[80px]" />
        ...
        <div className="w-full max-w-md relative z-10">
          ...
          <div className="relative rounded-2xl overflow-hidden">
            {/* Card Glow Border */}
            <div className="absolute inset-0 rounded-2xl bg-gradient-to-br from-primary/20 via-purple-500/10 to-primary/20 blur-sm" />
            
            <div className="relative rounded-2xl bg-card/90 backdrop-blur-2xl border border-white/10 p-8 shadow-[0_0_50px_rgba(0,0,0,0.3)]">
              {/* Subtle shine effect */}
                      ...
                      className={cn(
                        ...
                        selectedPlan === plan.id
                          ? plan.id === "premium"
                            ...
                            : "border-primary bg-primary/10 shadow-[0_0_30px_rgba(14,165,233,0.2)]"
                    ...
                    >
                      ...
                      {plan.popular && (
                        <div className="absolute -top-2.5 left-1/2 -translate-x-1/2 z-10">
                          <span className="px-2.5 py-1 text-[10px] font-semibold bg-gradient-to-r from-purple-500 to-pink-500 text-white rounded-full uppercase tracking-wider shadow-[0_0_20px_rgba(168,85,247,0.5)]">
                            Populaire
                          </span>
                        </div>
                      )}
                      <div className="relative">
                        ...
                        <div className="mb-1">
                          <span className={cn(
                            ...
                            plan.id === "premium" && "bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent"
                          )}>
                            {plan.price}
                          </span>
                          {plan.period && (
              ...
              {mode === "signup" && (
                <div className="mb-6 p-4 rounded-xl bg-secondary/30 backdrop-blur-sm border border-white/5">
                    ...
                    {plans.find(p => p.id === selectedPlan)?.features.slice(0, 4).map((feature, index) => (
                      <div key={index} className="flex items-center gap-2 text-sm">
                        <div className={cn(
                          ...
                          selectedPlan === "premium" ? "bg-purple-500/20" : "bg-primary/20"
                        )}>
                          <Check className={cn(
                            "h-2.5 w-2.5",
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                {mode === "signup" && (
                  <div className="relative group">
                    ...
                    <Input
                      ...
                      className="pl-11 h-12 bg-secondary/30 border-white/10 rounded-xl focus:border-primary/50 focus:ring-primary/20 transition-all"
                      required
                    />
                  </div>
                )}
                ...
                <div className="relative group">
                  ...
                  <Input
                    ...
                    className="pl-11 pr-11 h-12 bg-secondary/30 border-white/10 rounded-xl focus:border-primary/50 focus:ring-primary/20 transition-all"
                    required
                  />
                  <button
                    type="button"
                ...
                {mode === "signin" && (
                  <div className="text-right">
                    <button type="button" className="text-xs text-muted-foreground hover:text-primary transition-colors uppercase tracking-wider">
                      Mot de passe oublié ?
                    </button>
                  </div>
                )}
                ...
                <Button 
                  ...
                  className={cn(
                    ...
                    mode === "signup" && selectedPlan === "premium"
                      ? "bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 shadow-[0_0_30px_rgba(168,85,247,0.3)]"
              ...
              <div className="grid grid-cols-2 gap-3">
                <Button 
                  type="button" 
                  variant="outline" 
                  className="h-11 rounded-xl border-white/10 bg-secondary/20 hover:bg-secondary/40 hover:border-white/20 transition-all"
                >
